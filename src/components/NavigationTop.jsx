  ...
  return (
    <header className="fixed flex w-full justify-end item-center h-20">
      ...
      transition delay-150 duration-300 ease-in-out hover:scale-110"
        ...
        <a href="#contacts">
          <button
            className="flex items-center justify-center m-2 p-2 px-3 bg-transparent text-white border border-slate-300 
        transition delay-150 duration-300 ease-in-out  hover:rotate-x-360"
          >
