...
export default function Title({ Name, Description }) {
  return (
    <div className="md:shrink-0 min-h-screen max-h-screen bg-black flex items-center justify-center">
        <div className="w-full relative bg-gradient-to-r from-indigo-900 rounded-full py-10 text-gray-300 opacity-100">
          <h1 className="font-Nexa text-8xl text-center pt-4 pb-2 ">{Name}</h1>
          <p className="px-40 mx-14 ">{Description}</p>
          <ButtonNavi />
      </div>
    </div>
  );
