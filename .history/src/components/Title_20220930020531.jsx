    ...
    <div className="bg-black" id="home">
      <div className="flex items-center justify-center h-screen">
        ...
        <div className="relative max-w-lg min-w-[880px]">
          <div className="absolute inset-0.5 bg-gradient-to-r from-red-600 to-blue-600 rounded-full blur-3xl opacity-85
          group-hover:opacity-100 transition duration"></div>
