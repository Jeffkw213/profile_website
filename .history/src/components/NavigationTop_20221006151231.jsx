...
export default function ButtonNavi() {
  return (
    <header data-aos="fade-down" data-aos-easing="linear" data-aos-duration="150" className="fixed flex w-full justify-end item-center h-20">
      ...
      transition delay-150 duration-300 ease-in-out hover:scale-110"
        ...
        transition delay-150 duration-300 ease-in-out hover:scale-110 border border-slate-300 hover:bg-slate-600/20"
          >
