...
export default function Education(props) {
  ...
  return (
    <div data-aos='fade-up' className="h-screen p-2 bg-black text-white static max-w-1/2 w-full px-4" id="education">
      <div className="bg-rose-500 items-center justify-center p-10">
        <div>
