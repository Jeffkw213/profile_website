...
export default function Title({ Name, Description }) {
  ...
  // const star = () => {
  //   for (var i = 0; i < 100; i++) {
  //     '<div className="star m-0 bg-white" style=' +
  //       (Math.random() * 5 + 5) +
  //       's linear ' +
  //       (Math.random() * 1 + 1) +
  //       's infinite; top: ' +
  ...
  return (
    <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" className="bg-black max-w-1/2 w-full px-4" id="home">
