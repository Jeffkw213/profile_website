  ...
  return (
    <div className="px-8 min-h-screen max-h-screen bg-gray-100 flex items-center justify-center" id="home">
      ...
      <div className="relative w-full max-w-lg">
        <div className='absolute top-0 -left-4 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-'></div>
        <div className='absolute top-0 -right-4 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-'></div>
        <div className='absolute -buttom-8 left-20 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-'></div>
