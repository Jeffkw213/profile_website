  ...
  return (
    ...
    >
      <div
        ...
        className="bg-no-repeat bg-white border-8 border-york-500 p-24 sm:p-10 m-24 w-132 h-4/6 bg-opacity-100 rounded-2xl"
      >
        ...
        <a href="#skill">
          <button
            className="border border-red-500 sm:text-york-400 md:text-black 
                              ...
                              hover:scale-110 hover:text-york-400 shadow-2xl"
          >
            Skills learnt
          </button>
        </a>
