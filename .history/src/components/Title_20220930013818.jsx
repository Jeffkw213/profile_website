...
export default function Title({ Name, Description }) {
  return (
    <div className="px-8 min-h-screen max-h-screen bg-gray- flex items-center justify-center" id="home">
      {/* background blur */}

      <div className="relative max-w-lg min-w-[880px]">
        <div className='inset-0 bg-amber-600 rounded-lg'></div>
        <div className="relative max-h-full bg-gradient-to-r from-indigo-800 rounded-full py-10 text-gray-300 opacity-0">
