  ...
  return (
    <div className="h-screen p-2 bg-black text-red-700 flex justify-center text-justify-center static max-w-1/2 w-full px-4" id="education">
      ...
      >
        ...
        <a href="#skill">
          <button className="border border-red-500 sm:text-york-400 text-black round- w-auto m-3 p-3 bg-transparent ease-in-out duration-300 hover:scale-110 hover:text-york-400">Skills learnt</button>
        </a>
      </div>
    </div>
  );
