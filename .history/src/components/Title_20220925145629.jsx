...
export default function Title({ Name, Description }) {
  return (
    <div className="w-full min-h-screen max-h-screen bg-black flex items-center justify-center">
      <div className="relative resize-none bg-gradient-to-r from-indigo-900 rounded-full py-10 text-gray-300 opacity-100 overflow-x-scroll">
