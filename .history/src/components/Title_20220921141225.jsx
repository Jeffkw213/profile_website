  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="relative">
        <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-300 filter rounded-full blur-xl"></div>
        <div className="absolute top-0 -right-4 w-72 h-72 bg-yellow-300 filter rounded-full blur-xl"></div>
        <div className="absolute top-0 -bottom-4 w-72 h-72 bg-violet-300 filter rounded-full blur-xl"></div>
