...
export default function Education(props) {
  ...
  return (
    <div
      className="h-screen p-2 bg-cover bg-center text-bal-700 flex justify-center text-justify-center static max-w-1/2 w-full px-4"
      id="education"
    ...
    >
      <div
        ...
        className="bg-no-repeat bg-white border-8 border-york-500 p-24 m-24 max-w-1/2 h-4/6 bg-opacity-80"
      >
        <h2 className="font-Nexa font-medium text-4xl sm:text-8xl pt-4 pb-2">Education</h2>
        <p>
