...
export default function Title({ Name, Description }) {
  ...
  return (
    <div className="bg-black min-w-1/2" id="home">
      <div className="flex items-center justify-center h-screen">
        {/* background blur */}
        <div className="relative max-w-lg min-w-[880px]">
          <div className="relative inset-0.5 bg-gradient-to-r from-red-600 to-blue-600 rounded-full blur-2xl opacity-80"></div>
