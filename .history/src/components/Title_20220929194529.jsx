...
export default function Title({ Name, Description }) {
  return (
    <div className="px-8 min-w-[780px] min-h-screen max-h-screen bg-black flex items-center justify-center" id="home">
      <div className="flex items-center justify-center relative max-h-full bg-gradient-to-r from-indigo-900 rounded-full py-10 text-gray-300 opacity-100">
        ...
        <button className="flex items-center justify-center items-between">
