...
export default function Title({ Name, Description }) {
  return (
    <div className="px-8 min-w-[780px] min-h-screen max-h-screen bg-black flex items-center justify-center">
      <div className="relative max-h-full bg-gradient-to-r from-indigo-900 rounded-full py-10 text-gray-300 opacity-100">
        <h1 className="font-Nexa text-8xl text-center pt-4 pb-2 object-cover">{Name}</h1>
