  ...
  return (
    <div className="px-8 min-h-screen max-h-screen bg-black flex items-center justify-center" id="home">
      ...
      <div className="relative max-w-lg min-w-[880px]">
        <div className='absolute inset-0.5 bg-gradient-to-r from-amber-600 to-blue-600 rounded-full blur-xl opacity-75'></div>
        <div className="relative max-h-full bg-gradient-to-r from-indigo-800 rounded-full py-10 text-gray-300 ">
