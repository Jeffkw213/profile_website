  ...
  return (
    ...
    >
      ...
      >
        ...
        <a href="#skill">
          <button
            className="border bg-gradient-to-r from-green-400 to-blue-500 border-red-500 sm:text-york-400 md:text-black 
                              rounded-full w-auto m-3 p-3 bg-transparent ease-in-out duration-300 
                              hover:scale-110 hover:bg-gradient-to-t hover:text-york-400 shadow-md"
          >
            Skills learnt
          </button>
        </a>
