...
export default function Title({ Name, Description }) {
  return (
    <div className="min-h-screen max-h-screen bg-cover w-auto bg-black flex items-center justify-center">
        <div className="absolute items-center top-0 -left-0 w-72 h-72 bg-purple-300 filter rounded-full blur-xl opacity-70"></div>
