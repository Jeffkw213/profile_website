  ...
  return (
    ...
    >
      <div
        ...
        className="bg-no-repeat bg-white border-8 border-york-500 p-24 sm:p-10 m-24 w-132 h-4/6 bg-opacity-80 rounded-2xl"
      >
        ...
        <a href="#skill">
          <button
            className="border bg-gradient-to-r from-green-400 to-blue-500 sm:text-york-400 md:text-black 
                              rounded-full w-auto m-3 p-3 bg-transparent ease-in-out duration-300 
                              hover:scale-110 hover:from-pink-500 hover:to-yellow-500 hover:text-york-400 shadow-md"
          >
            Skills learnt
          </button>
        </a>
