...
export default function Title({ Name, Description }) {
  ...
  function Stars() {
    ...
    for (let i = 0; i < 100; i++) {
      ...
      arr.push(<div className={`bg-white w-2 h-2 rounded-full absolute top-[${vh}px] left-[${vw}px]`} key={`${i}`}></div>);
    }
    return arr;
  }
  return (
    <div className="bg-black max-w-1/2 w-full px-4" id="home">
      ...
      <div className="flex items-center justify-center h-screen">
        ...
        transition delay-150 duration-300 ease-in-out hover:scale-110 shadow-2xl"
                >
        ...
        transition delay-150 duration-300 ease-in-out hover:rotate-y-360 shadow-2xl"
                >
