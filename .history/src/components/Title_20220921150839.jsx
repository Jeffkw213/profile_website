...
const ButtonNavi = () => (
  <nav className="p-3 text-center">
    ...
    <a href="/Resume.pdf" target="_blank">
      <button
        className="m-2 p-2 px-3bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 text-white rounded-full
      transition delay-150 duration-300 ease-in-out hover:scale-110 hover:from-pink-500 hover:to-yellow-500"
      >
        Resume
      </button>
    </a>
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="relative">
        ...
        <div className="relative bg-gradient-to-r from-indigo-900 rounded-full py-10 text-gray-300 opacity-100">
