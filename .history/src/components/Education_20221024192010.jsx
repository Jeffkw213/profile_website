  ...
  return (
    ...
    >
      <div
        ...
        className="bg-no-repeat bg-white border-8 border-york-500 p-24 sm:p-10 m-24 w-132 h-4/6 bg-opacity-80"
      >
        <h2 className="font-Nexa font-medium sm:font-bold text-4xl sm:text-8xl pt-4 pb-2 text-shadow-md text-york-700">Education</h2>
        <p>
