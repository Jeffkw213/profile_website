  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="relative">
        <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-300 filter rounded-full blur-xl opacity-70"></div>
        <div className="absolute top-0 -right-1 w-72 h-72 bg-yellow-300 filter rounded-full blur-xl opacity-70"></div>
        <div className="absolute top-0 -left-4 w-72 h-72 bg-violet-300 filter rounded-full blur-xl opacity-70"></div>

        <div className="bg-gradient-to-r from-indigo-900 rounded-full py-10 text-gray-300 opacity-100">
