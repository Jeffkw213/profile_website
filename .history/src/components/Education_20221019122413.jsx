...
export default function Education(props) {
  ...
  return (
    <div className="h-screen p-2 bg-black static max-w-1/2 w-full px-4" id="education">
      <div
        data-aos="fade-up"
        data-duration="1500"
        data-aos-anchor-placement="center-center"
        className="bg-no-repeat bg-cover bg-center border-2 border-york-500 p-10 m-24 max-w-1/2 h-4/6"
