    ...
    <ul className="">
      <li className="inline-block">
        <a href={props.Linkedin} target="_blank" rel="noopener noreferrer">
          <img src={Linkedin} alt="Linkedin Logo" className="h-16 opacity-[.35]" />
        </a>
      </li>
      <li className="inline-block">
        <a href={props.Github} target="_blank" rel="noopener noreferrer">
          <img src={Git} alt="Git Logo" className="h-16 opacity-[.35]" />
        </a>
      </li>
      <li className="inline-block ml-2">
        <a href={`mailto:${props.Email}?subject=Hi%20I'm%20Stupid`}>
          <img src={Gmail} alt="Gmail Logo" className="h-16 opacity-[.35]" />
        </a>
      </li>
    </ul>
  </nav>
