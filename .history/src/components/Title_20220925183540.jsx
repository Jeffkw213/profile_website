...
export default function Title({ Name, Description }) {
  return (
    <div className="min-w-[50%] min-h-screen max-h-screen bg-black flex items-center justify-center">
      <div className="relative h-screen bg-gradient-to-r from-indigo-900 rounded-full py-10 text-gray-300 opacity-100">
